...
├── hacs.json                 # HACS manifest (name: "AX Dose Logger Card", render_readme: true, filename: ax-dose-logger-card.js)
...
├── .github/
│   └── workflows/
│       └── hacs.yaml         # HACS validation CI (push/PR on main → hacs/action@main, category: plugin)
...
| [`hacs.json`](hacs.json) | HACS manifest — name: "AX Dose Logger Card", render_readme: true, filename: "ax-dose-logger-card.js", homeassistant/hacs version gates |
| [`.github/workflows/hacs.yaml`](.github/workflows/hacs.yaml) | HACS validation CI — triggers on push + pull_request to main; runs hacs/action@main with category: plugin |
