...
This document is for power users customizing the card's button styling/animations, choosing a color scheme, or hand-configuring the card in YAML. The visual editor handles all of this automatically — you only need these details if you're fine-tuning the look or writing YAML by hand.

- [Button State Matrix](#button-state-matrix)
- [Button Style Options](#button-style-options)
- [Icon Style Options](#icon-style-options)
- [Logged Dose Indicator Flash](#logged-dose-indicator-flash)
- [Color Scheme and Indicator Conflict](#color-scheme-and-indicator-conflict)
- [Disruption Box Display Modes](#disruption-box-display-modes)
- [Press Ripple (ha-ripple)](#press-ripple-ha-ripple)
...
The **Logged Animation Duration** controls how long the flash appears (default 3000ms, configurable 500–10000ms).
...
## Color Scheme and Indicator Conflict
...
## Disruption Box Display Modes

The Disruption box (Master Tracker Drinks tab bottom box) has **three display modes** (selectable via `disruption_mode` in the visual editor):
